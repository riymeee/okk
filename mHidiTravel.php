...
<html lang="en">
    ...
    <title>M'Hidi Travel</title>
    
    <link href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css"/>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css">
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" href="mHidiTravel.css">
    <style>
         .btn-des {
...
<body>
    ...
    <!-- Section de l'entête -->
     ...
     <section class="home" id="home" >
        ...
        <div class="content">
            <h3> Welcome To alhayat Agency</h3>
...
<div class="video-container">
    <video src="./1990001019_pin.mp4"id="video slider" loop autoplay muted></video>
    ...
    <div class="content">
        ...
        if (mysqli_num_rows($query_run) > 0) {
            while ($row = mysqli_fetch_assoc($query_run)) {
                $image_path = 'admin/uploaded_img/' . $row['photo'];
                if (file_exists($image_path)) {
                    echo '
                    <div class="cardn" style="background-image: url(\'' . $image_path . '\');">
                        <h3>' . $row['name'] . '</h3>
                        <a href="offres.php?id=' . $row['id_des'] . '" class="btn-des">Discover More</a>
                    </div>
                    ';
                } else {
...
<section class="gallery" id="gallery">
    ...
    <div class="box-container">
        ...
        <div class="content">
            ...
            <a href="offres.php" class="btn">see more</a>
        </div>
    </div>
    <div class="box">
...
<section class="footer">
    <div class="box-container">
        <div class="box">
            ...
            <a href="rating.php"><i class="fas fa-angle-right"></i>Raiting</a>
        </div>
        <div class="box">
            <h3>Extra Links</h3>
